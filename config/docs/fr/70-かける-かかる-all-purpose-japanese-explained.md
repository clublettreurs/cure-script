...
mais comme je l'ai souligné dans une [**vidéo récente**](https://www.youtube.com/watch?v=CpiELpGR-VU&ab_channel=OrganicJapanesewithCureDolly), il n'est pas courant que deux mots de langues différentes occupent exactement la même zone du spectre de la signification, donc ce n'est pas précisément la même chose que les verbes français **pendre** ou **accrocher**. Et puis il y a ces deux versions, `かかる` (*kakaru*) et `かける` (*kakeru*), qui sont les versions **mouvement propre** (*self-move*) et **mouvement de l'autre** (*other-move*) du mot.
...
`腰` (*koshi*) est nos hanches, l'extrémité inférieure du torse, donc `腰をかける` signifie **s'asseoir**, suspendre l'extrémité inférieure de notre torse quelque part.
