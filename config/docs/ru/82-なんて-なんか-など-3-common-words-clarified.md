...
**<code>なんて</code> по сути является сокращением от <code>何って</code>**, и я делала другое видео об этом <code>-って</code>, которое является сокращением от <code>-と</code> или <code>-という</code>.
*(Урок 18)*
...
И я говорила об этом <code>らしい</code> и <code>らしくない</code> в другом видео. *(Урок 25)* Так что, если вы с ними не знакомы, я оставлю ссылку над моей головой и в разделе информации ниже.
