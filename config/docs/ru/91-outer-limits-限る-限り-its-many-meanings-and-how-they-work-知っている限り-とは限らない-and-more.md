...
Если вы не знаете, как い-основы образуют существительные формы, я прикреплю видео над головой, которое раскроет вам все секреты таинственной い-основы.
*(Урок 72)*

Итак, **японский язык любит выражения, связанные с ограничениями и границами.** [**Я делала видео**](https://www.youtube.com/watch?v=56sy0qfY0Js) об <code>うち</code> *(Урок 97)* некоторое время назад, и я оставлю ссылку над головой и в разделе информации ниже. <code>うち</code> фокусируется на замкнутом пространстве, на области, в которой мы находимся, и всё остальное находится за её пределами.
...
И, как мы говорили на прошлой неделе *(Урок 90)*, **модификация выполняет огромную часть основной работы в японском языке,** **которая в английском выполняется другими стратегиями.**
...
**<code>その場</code>**, которое мы обсуждали в другом видео, на которое я дам ссылку *(Урок 75)*, буквально означает **<code>то самое место / подходящее место / место, где кто-то оказался в данный момент</code>**, но **конечно, в японском, как и в других языках, <code>место</code> также может означать время или случай.**
