...
**Вы можете образовывать основы прилагательных, отбрасывая <code>い</code>, точно так же, как мы отбрасываем <code>る</code> в ичидан-глаголах,** **или изменяя эту <code>い</code> на одну из трёх кан ряда <code>ка</code>: <code>ка</code>, <code>ке</code> или <code>ку</code>.**
...
**Он*/Японский язык* имеет два вида слов: активные и пассивные слова, изменяемые и инертные слова.**
