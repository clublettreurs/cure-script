...
**И в большинстве более распространённых случаев это использовалось в период Эдо вместе со словом <code>ほど</code>.** И я также сделала недавнее видео о <code>ほど</code>, так что я оставлю ссылку. *(Урок 94)*
