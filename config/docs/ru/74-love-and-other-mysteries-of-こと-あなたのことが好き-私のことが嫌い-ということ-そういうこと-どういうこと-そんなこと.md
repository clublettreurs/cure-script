...
И наоборот, вещи, которые культура особенно желает выразить, — это те вещи, которые становятся гибкими в языке. Итак, если вы хотите узнать больше о гибкости, пожалуйста, посмотрите моё видео на эту тему *(Урок 56)*.
...
Но многие люди просили меня объяснить выражения вроде <code>どういうこと</code> и <code>そういうこと</code>, и я уже затрагивала их раньше *(Урок 20)*, так что я просто немного повторю.
