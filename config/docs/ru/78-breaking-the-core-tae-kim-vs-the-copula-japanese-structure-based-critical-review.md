...
Теперь, другая вещь, я думаю, которая позволяет представить, что <code>です</code> — это не та же связка, что и <code>だ</code>, заключается в том, что **<code>です</code> и <code>ます</code> обе немного эксцентричны** — и я сделала целое видео об этом. ***(Урок 17)***
...
**<code>ない</code> — это вспомогательное прилагательное, которое присоединяется к основе <code>食べる</code>**. **<code>たい</code> — это другое вспомогательное прилагательное, которое присоединяется к основе <code>食べる</code>**. И я объяснила всё это в своём видео о японской системе основ. *(Урок 7.5)*
