...
Например, мы говорили в прошлом *(Урок 48?)* о <code>くれる</code> и <code>あげる</code>, и я думаю, что у нас часто складывается впечатление, что это имеет много общего с более личным чувством отношения.
