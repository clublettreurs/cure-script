...
Ну, здесь нужно понять, что счётные слова — это не обычные существительные. Это то, что я назвала в своём видео о специальных типах существительных *(Урок 41)*, я назвала их <code>хитрыми существительными</code>, то есть <code>наречными существительными</code>.
