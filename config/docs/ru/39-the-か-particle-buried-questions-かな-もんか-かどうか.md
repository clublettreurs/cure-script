...
Ещё одно место, где мы часто видим частицу か как отрицательный вопросительный маркер, это в <code>どころか</code>. Итак, <code>どころ</code> — это форма <code>ところ</code>, о которой мы говорили в недавнем уроке, не так ли? *(Урок 36)*
