...
Итак, **что означает вспомогательный глагол получения? Он означает `получать` или `получить`.** **Получать что? Получать действие глагола, к которому он присоединён.**

![](../media/image647.webp)

Теперь, **большую часть времени я буду использовать слово `получить`, потому что оно очень чётко выражает то, что делает этот вспомогательный глагол.**
...
**叱る/しかる означает `ругать` или `отчитывать`, а あ-основа — 叱ら, поэтому, когда мы добавляем к ней れる и ставим в прошедшее время, мы получаем しかれた/叱られた.** **叱る — это `ругать`, 叱られる — это `получить выговор`, 叱られた — это `получила выговор`, то есть `Сакура получила выговор`.**
...
Теперь, **давайте также заметим, что А-вагон, актор предложения, не обязательно является человеком.** Итак, если мы скажем 「**水**がのまれた」 (のむ/飲む＝пить; のま＝ あ-основа от пить; れた＝ получил), мы говорим `**Вода** была выпита`. **И актор этого предложения — вода.**
...
(盗む/ぬすむ＝ красть; 盗ま＝ あ-основа от красть; 盗まれる＝ быть украденным; 盗まれた＝ был украден). **誰か/だれか означает `кто-то`** (誰＝ кто, か＝ вопрос). Кто это был? Мы не знаем, никто конкретный, но кто-то. **誰か＝Кто-то**.

---

Итак, что здесь происходит? Кто является получателем действия? Это не Сакура, которая помечена частицей は. Это не кто-то, кто помечен частицей に. **Это `тот`, кто помечен частицей が, и это сумка. Сумка — это то, что получило это воровство, поэтому сумка является субъектом предложения. Сумка — это та, кто совершила れる, кто `получила`.**
...
Теперь, есть ещё одна область, в которой вспомогательный глагол получения иногда сбивает людей с толку, и это так называемый <code>страдательный пассив</code> или <code>пассив неблагоприятных обстоятельств</code>, который на самом деле называется в японском языке 迷惑受け身/*めいわくうけみ*, что означает `досадный вспомогательный глагол получения`. И это именно то, чем он является. Это досадный вспомогательный глагол получения.

---

「さくらはだれかに**かばんが**ぬすまれた。」 означает `У Сакуры **сумка** была украдена кем-то` или, буквально, `Что касается Сакуры, **сумка** была украдена кем-то`.
::: info
...
Итак, что означает это предложение в английском? Очень просто: `У **Сакуры** украли сумку`. Именно так мы говорим в английском; нашему старому учителю английского это может не понравиться, но мы так говорим в английском, это имеет смысл в английском, и это именно то, что мы говорим в японском. `У Сакуры украли сумку кем-то.`
